...
public class AbstractBeingBDI
{
	...
	public void body()
	{
		...
		agent.dispatchTopLevelGoal(new PerformIdleForTime((int)(10000+Math.random()*5000)));
	}
...
//			System.out.println("new perform idle");
	 ...
	 *  the Agent just Idles or Patrols
	 */
	@Goal(excludemode=MGoal.EXCLUDE_WHEN_SUCCEEDED, succeedonpassed=true, deliberation=@Deliberation(inhibits={PerformIdle.class, MaintainCreatureAwake.class, PerformOccupyLair.class}))
