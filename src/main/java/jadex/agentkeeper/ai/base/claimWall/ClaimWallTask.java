...
public class ClaimWallTask extends AbstractTask {

	private static final int DELAY_RESET_COUNT = 100;

	/** The destination property. */
	public static final String PROPERTY_TYPENAME = "claimWallTask";
...
//	}
	...
	public void execute(IEnvironmentSpace space, ISpaceObject obj, long progress, IClockService clock) {
		obj.setProperty(ISObjStrings.PROPERTY_STATUS, PlanType.Types.DIG );
